...
<div class="flex flex-wrap items-center justify-center w-full h-full">
  ...
  <li class="flex items-center justify-start w-full bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">
    ...
    <path fill="url(#a7fee970-a784-4bb1-af8d-63d18e5f7db9)" d="M66.595 9.364a4.145 4.145 0 0 0-3.928-2.82H33.648a4.146 4.146 0 0 1 3.928 2.82l25.184 74.62a4.146 4.146 0 0 1-3.928 5.472h29.02a4.146 4.146 0 0 0 3.927-5.472z"/></svg><span class="mx-2">AZURE</span></li>
  <li class="flex items-center justify-start w-6/12 bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">
    
    <svg class="mx-2" height="1.25rem" xmlns="http://www.w3.org/2000/svg" 
	 viewBox="0 0 304 182" style="enable-background:new 0 0 304 182;" xml:space="preserve">
<g>
	<path style="fill:#252F3E;" class="st0" d="M86.4,66.4c0,3.7,0.4,6.7,1.1,8.9c0.8,2.2,1.8,4.6,3.2,7.2c0.5,0.8,0.7,1.6,0.7,2.3c0,1-0.6,2-1.9,3l-6.3,4.2
...
<span class="mx-2">AWS</span></li>
  <li class="flex items-center justify-start w-3/4 bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest"><svg class="mx-2" xmlns="http://www.w3.org/2000/svg" height="1.25rem" viewBox="0 0 32 32">
...
<span class="mx-2">ANSIBLE</span></li>
  <li class="flex items-center justify-start w-3/4 bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">
    <svg class="mx-2" height="1.25rem" viewBox="-17.5 0 291 291" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
    <g>
    ...
    <span class="mx-2">TERRAFORM</span></li>
  <li class="flex items-center justify-start w-full bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">AZURE DEVOPS</li>
  <li class="flex items-center justify-start w-3/4 bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">JENKINS</li>
  <li class="flex items-center justify-start w-full bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">POWERSHELL</li>
  <li class="flex items-center justify-start w-6/12 bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">PYTHON</li>
   <li class="flex items-center justify-start w-full bg-orange-800 text-xl m-2 p-1 md:p-3 font-semibold tracking-widest">ARM DEPLOYMENT</li>
</ul>
</div>
 <!-- <div class="flex flex-wrap content-center w-full h-[50vh] bg-red-600">
     <ul class="flex p-2 relative items-center text-6xl w-full h-[5rem] font-bold">
       ...
       <li class="h-full w-2/12 flex items-center justify-start"><svg xmlns="http://www.w3.org/2000/svg" width="83" height="100%" viewBox="0 0 83 97">
  ...
  <g id="Polygon_2" data-name="Polygon 2" transform="translate(0 97) rotate(-90)" fill="#850081">
    ...
    <path d="M 48.5 19.82093048095703 L 17.42548370361328 73 L 79.57451629638672 73 L 48.5 19.82093048095703 M 48.5 0 L 97 83 L 0 83 L 48.5 0 Z" stroke="none" fill="#230101"/>
  </g>
</svg>
</li>
     </ul>
